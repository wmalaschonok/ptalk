Neo4j 3.1.1-SNAPSHOT
=======================================

Welcome to Neo4j release 3.1.1-SNAPSHOT, a high-performance graph database.
...
For full instructions, see https://neo4j.com/docs/operations-manual/current/deployment/
